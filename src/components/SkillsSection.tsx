        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-black dark:text-white">Networking & Infrastructure</h3>
            </div>
            <div className="space-y-4">
              {[
                { skill: 'CCNA Certification', level: 90, icon: Network },
                { skill: 'GNS3 & EVE-NG', level: 85, icon: Server },
                { skill: 'Network Automation', level: 80, icon: Terminal },
                { skill: 'Linux Systems', level: 88, icon: Terminal },
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-black dark:text-white">Programming & Development</h3>
            </div>
            <div className="space-y-4">
              {[
                { skill: 'Python', level: 92, icon: Code },
                { skill: 'PHP & MySQL', level: 75, icon: Globe },
                { skill: 'Java', level: 85, icon: Code },
                { skill: 'HTML, CSS, JavaScript/React', level: 80, icon: Code },
              ].map(({ skill, level, icon: Icon }) => (
                <div key={skill} className="group">
                  <div className="flex justify-between items-center mb-2">
                    <div className="flex items-center space-x-2">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-black dark:text-white">Tools & Technologies</h3>
            </div>
            <div className="space-y-4">
              {[
                { skill: 'Git & GitHub', level: 85, icon: Github },
                { skill: 'Linux', level: 70, icon: Server },
                { skill: 'Database Management', level: 75, icon: Database },
                { skill: 'Web Development', level: 72, icon: Globe },
              ].map(({ skill, level, icon: Icon }) => (
                <div key={skill} className="group">
                  <div className="flex justify-between items-center mb-2">
                    <div className="flex items-center space-x-2">
